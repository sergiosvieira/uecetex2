...
\autor{Alexandra da Silva Lima}
\titulo{CUIDADO A HIPERTENSOS E DIABÉTICOS NA APS: análise de rede social do enfermeiro}
\data{2015}
\local{Fortaleza -- Ceará}

% Exemplo: \dataaprovacao{01 de Janeiro de 2012}
\dataaprovacao{20 de Julho de 2015}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%     Informação sobre o Orientador       %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\orientador{Profa. Dra. Maria Rocineide Ferreira da Silva}
...
\membrodabancadois{Profa. Dra. Lucilane Maria Sales da Silva}
\membrodabancadoiscentro{Centro de Ciências da Saúde - CCS}
\membrodabancadoisies{Universidade Estadual do Ceará – UECE}

\membrodabancatres{Ms. Thayza Miranda Pereira}
\membrodabancatrescentro{Centro de Educação Permanente em Vigilância da Saúde - CEPVS}
\membrodabancatresies{Escola de Saúde Pública do Ceará - ESP-CE}
% 
...
\begin{document}	
	...
	\imprimirapendices
		...
		%\input{elementos-pos-textuais/apendices/instrumento-coleta}
		\input{elementos-pos-textuais/apendices/glossario}
	\imprimiranexos
		% Adicione aqui os anexos do seu trabalho
		%\input{elementos-pos-textuais/anexos/cronograma}
		%\input{elementos-pos-textuais/anexos/orcamento}
		\input{elementos-pos-textuais/anexos/roteiro}
		\input{elementos-pos-textuais/anexos/termo}
	\imprimirindice
