...
\autor{Alexandra da Silva Lima Vieira}
\titulo{Ações do Enfermeiro no Pré-natal a Gestantes com Sífilis: Uma Revisão Integrativa}
\data{2019}
...
\membrodabancadois{Ms. Katherine Jerônimo Lima}
\membrodabancadoiscentro{Centro de Ciências da Saúde - CCS}
\membrodabancadoisies{Fundação Norte Riograndense de Pesquisa e Cultura- FUNPEC}

\membrodabancatres{Ms. Leidy Dayane Paiva de Abreu}
