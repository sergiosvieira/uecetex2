...
\afterpage{%
    ...
    \begin{landscape}% Landscape page
        ...
        \begin{quadro}[h!]
        \Caption{\label{qua:q1} Resultados}
        \UECEqua{}{
			\begin{tabular}{|p{3cm}|p{2cm}|p{2cm}|p{3cm}|p{2cm}|p{3cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
			\hline 
			Título & Base de dados & Autor & Cidade/Estado/País & Amostra & Interesse & Tipo & Local do Estudo & Ações & Estratégia para adesão \\ 
			\hline 
			Assistência Pré-natal no contexto da estratégia de saúde da família & BDENF & Pitombeira et al. & São Gonçalo do Amarante/Ceará/Brasil & 632 & Estudar o acompanhamento pré-natal oferecido no município de São Gonçalo do Amarante com base nas informações do SIAB, SISPRENATAL, SINASC, SINANNET e SIM & Estudo descritivo, com abordagem quantitativa & SIAB, SISPRENATAL, SINASC, SINANNET e SIM & Exames VDRL & Busca ativa (realizada pelo ACS) \\ 
			\hline 
			Assistência pré-natal a gestante com diagnóstico de sífilis & BDENF & Suto et al.& Jacobina/Bahia/Brasil & 667 e 6 (3 enfermeiras e 3 gestantes) & Investigar qual tem sido a assistência prestada às gestantes com sífilis na Atenção Básica. & Estudo transversal e exploratório & SINAN, SisPreNatal e nas unidades de Saúde da Família e residência das gestantes do município de Jacobina-Bahia. & Prescrição de penicilina G benzatina & Atividades educativas sobre sífilis na UBS \\ 
			\hline 
			\end{tabular}
		}{
...
\afterpage{%
    ...
    \begin{landscape}% Landscape page
        ...
        \UECEqua{}{        
			...
			Título & Base de dados & Autor & Cidade/Estado/País & Amostra & Interesse & Tipo & Local do Estudo & Ações & Estratégia para adesão \\ 
			\hline 
			Monitoramento das ações pró-redução da transmissão vertical da sífilis na rede pública do DF & BDENF & Tavares et al.& Distrito Federal/Brasil & 3.726 & Analisar o perfil epidemiológico e a cobertura de realização do VDRL durante a gestação e o parto, em gestantes e parturientes atendidas na rede pública de saúde do DF & Quantitativo & Hosp. Reg. da Asa Sul, Norte, e outros. & Preenchimento do cartão das gestantes incompleto, poucas gestantes apresentavam 3 VDRL no pré-natal & Não há \\ 
			\hline 
			Sífilis Na Gestação: Perspectivas e Condutas do Enfermeiro & BDENF-Enfermagem & Nunes et al. & Natal/RN/Brasil & 4 enfermeiros  & Discutir as ações do enfermeiro na atenção pré-natal a gestantes com sífilis e identificar dificuldades encontradas pelos profissionais na adesão ao tratamento das gestantes e parceiros. & Qualitativo, descritivo-exploratório. & Unidade Mista Felipe Camarão & Estado da gestante, adesão ao tratamento dela e do parceiro. Importância do tratamento. Gestantes com sinal de alarme & Solicitação mensal do VDRL. Acolher de forma tranquilizadora. Atividades educativas. Orientar sobre fatores de risco e à vulnerabilidade. \\ 
			\hline 
			\end{tabular}
		}{
			\Fonte{Elaborado pelo autor}
...
\afterpage{%
    ...
    \begin{landscape}% Landscape page
        ...
        \UECEqua{}{        
			...
			Título & Base de dados & Autor & Cidade/Estado/País & Amostra & Interesse & Tipo & Local do Estudo & Ações & Estratégia para adesão \\ 		
			\hline 
			Sífilis congênita no Ceará: análise epidemiológica de uma década & LILACS & Costa et al. & Ceará/Brasil & 10.000 nascidos vivos. 2.930 casos de SC & avaliar a taxa de notificação de SC no CE nos anos de 2000/2009 de acordo com SINAN, descrever o perfil epidemiológico das gestantes cujos RN tiveram SC; verificar realizaçao do pré-natal e tratamento das gestantes cujos RN tiveram SC e tratamento de seus parceiros. & Transv. e doc., com abordagem quant. & Documental, realizado em jul/2010 - NUIAS da SESA/CE & consultas realizadas de forma inadequada & Não há. \\ 
			\hline 
			Avaliação da assistência pré-natal em município do Sul do Brasil & BDENF & Segatto et al. & Município de Segredo - R.G.Sul/Brasil & 80 & Verificar a efetividade da assistência pré-natal através de indicadores de processo. &Descritivo, com delineamento documental & SISPRENATAL implantado no setor de Epide. da SMS. & VDRL, consultas, preenchimento inadequado do cartão da gestante & Não há \\ 
			\hline 
			\end{tabular}
		}{
			\Fonte{Elaborado pelo autor}
